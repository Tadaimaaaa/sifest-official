...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-[100svh] bg-slate-50 text-slate-900 flex flex-col md:flex-row overflow-hidden relative">
      {/* Ambient background */}
      ...
      <aside className={`
        ...
        fixed md:static inset-y-0 left-0 w-64 bg-white border-r border-slate-200 z-30 shadow-2xl shadow-slate-200/50 md:shadow-none
        flex flex-col
      `}>
        ...
        <div className="p-4 border-t border-slate-200">
          <Link href="/admin/login" className="flex items-center justify-center gap-2 w-full py-3 bg-red-50 text-red-600 rounded-xl hover:bg-red-100 transition-colors border border-red-100">
            <LogOut size={18} />
