    ...
    <main className="relative min-h-[100svh] w-full overflow-hidden bg-[#050a15]">
      ...
      <div className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden flex items-center justify-center min-h-[50vh]">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          Sistem Informasi Festival adalah <strong className="text-white">program kerja terbaru</strong> dari Himpunan Mahasiswa Jurusan Sistem Informasi. Sebuah terobosan inovatif untuk menautkan ribuan talenta digital muda dalam satu perayaan teknologi terbesar.
          </p>
        </div>
      </div>
