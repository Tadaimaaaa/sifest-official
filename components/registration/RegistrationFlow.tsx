                ...
                <div className="max-w-xl mx-auto text-center space-y-6 glass-medium p-10 rounded-[2rem] border border-brand-accent/20 animate-in fade-in zoom-in duration-500">
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-xl p-8 my-6 flex flex-col items-center">
                    ...
                    <RegistrationCountdown 
                      startDate={selectedEvent?.registrationStartDate || "2026-10-01T00:00:00+07:00"} 
                      closeDate={selectedEvent?.registrationCloseDate || "2026-10-25T23:59:59+07:00"}
                      variant="hero"
                    />
                  </div>
                      ...
                      <div className="space-y-3">
                        <div className="bg-white/5 p-3 sm:p-4 rounded-lg border border-white/10 flex items-center gap-3 sm:gap-4">
                          <div className="bg-white rounded-lg p-2 flex-shrink-0">
                            <Image src="/images/banks/logo-bri.jpg" alt="BRI" width={64} height={42} className="object-contain w-10 sm:w-16" />
                          </div>
                          <div className="flex-1">
                            <p className="text-white font-mono text-sm sm:text-lg font-bold">817301013354530</p>
                            <p className="text-white/60 text-xs sm:text-sm leading-tight mt-0.5">a.n. ZHARA DELVIA PUTRI</p>
                          </div>
                        </div>
                        <div className="bg-white/5 p-3 sm:p-4 rounded-lg border border-white/10 flex items-center gap-3 sm:gap-4">
                          <div className="bg-white rounded-lg p-2 flex-shrink-0">
                            <Image src="/images/banks/logo-bank-nagari.jpg" alt="Bank Nagari" width={64} height={42} className="object-contain w-10 sm:w-16" />
                          </div>
                          <div className="flex-1">
                            <p className="text-white font-mono text-sm sm:text-lg font-bold">10030234000065</p>
                            <p className="text-white/60 text-xs sm:text-sm leading-tight mt-0.5">a.n. FACHRATUN RAHIMA</p>
                          </div>
                        </div>
                      </div>
